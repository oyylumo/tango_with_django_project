# create a ModelForm class for each model that you wish to
# represent as a form

# we specify which fields are included in the form with the
# fields = ("name") or excluded with exclude("Category")
